...
switch ($style) {
    ...
    case 'success':
        ...
        break;
    case 'danger':
        $classes = 'inline-flex items-center p-2 bg-red-600 disabled:opacity-25 border border-transparent rounded-md font-semibold text-xs text-gray-600 dark:text-gray-100 uppercase tracking-widest hover:bg-red-500 active:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition ease-in-out duration-150';
        break;
    default:
