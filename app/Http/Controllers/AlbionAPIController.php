...
class AlbionAPIController extends Controller
{
    ...
    public function fetchDeathLogByBattleId(Request $request) {
        ...
        DiscordAlert::message("<@" . Auth()->user()->id . "> opened regears for this [battleboard](https://east.albionbattles.com/multilog?ids=" . implode(",", $formattedBattleIds) . "). The regears in the battleboard has an estimated cost (in buy orders) of " . number_format($battleTotalCost) . ". @everyone");
